...
class HlhbTrendRiskManagedStrategy(IStrategy):
    INTERFACE_VERSION = 3
    ...
    # Keep the original trade logic and trailing behavior,
    # but cap downside much earlier than the original 32% stop.
    stoploss = -0.10
    trailing_stop = True
